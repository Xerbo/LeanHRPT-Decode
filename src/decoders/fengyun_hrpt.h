...
#ifndef LEANHRPT_DECODERS_FENGYUN_HRPT_H_
#define LEANHRPT_DECODERS_FENGYUN_HRPT_H_
...
class FengyunHRPTDecoder : public Decoder {
   public:
    FengyunHRPTDecoder(SatID sat) : virrDeframer(8, false) {
        ...
        switch (sat) {
            case SatID::FengYun3A:
                launch_timestamp = 1289347200.0;
                break;
            case SatID::FengYun3B:
                launch_timestamp = 1289347200.0;
                break;
            case SatID::FengYun3C:
                launch_timestamp = 1522368000.0;
                break;
            default:
                throw std::runtime_error("Non FY SatID passed to FengyunHRPTDecoder");
        }
    }
    ~FengyunHRPTDecoder() {
        delete[] frame;
